        ...
        <>
            <div className="p-8 max-w-2xl mx-auto">
                ...
                <div className="mt-6 bg-gray-100 p-4 rounded-xl dark:text-black">
                    ...
                    <p className="mt-7 text-center break-words">Podés guardar este link para seguir el estado de tu orden: <Link href={`/order/${result.orderToken}`} className="border-b-2 text-sky-500 border-sky-500 hover:text-sky-600 hover:border-sky-600 transition-colors break-all">{`https://almacencriollosunchales.vercel.app/order/${result.orderToken}`}</Link></p>
                </div>
            </div>
        </>
    )
